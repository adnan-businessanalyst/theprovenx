...
const resources = {
  "en": {
    "translation": {
      ...
      "products": {
        "title": "Our Products",
        "subtitle": "Experience The Proven X anywhere.",
        "web": "Web Community",
        "web_desc": "The core platform for asking, answering, and verifying.",
        "mobile": "Mobile App",
        "mobile_desc": "Take the community on the go. Available now.",
        "plans": "Plans",
        "free": "Free",
        "free_desc": "Full access to read and contribute.",
        "paid": "Pro",
        "paid_desc": "Advanced features and priority support.",
        ...
        "price_free": "$0/mo",
        "price_paid": "???/mo",
        "feature_ask": "Ask unlimited questions",
        "feature_post": "Post and verify answers",
        "feature_vote": "Vote on content",
        "feature_profile": "Basic profile",
        "feature_everything": "Everything in Free",
        "feature_support": "Priority support",
        "feature_analytics": "Advanced analytics",
        "feature_badges": "Custom profile badges"
      },
      "blog": {
        "title": "Blog",
        "read_more": "Read More",
  ...
  "ar": {
    "translation": {
      ...
      "products": {
        "title": "منتجاتنا",
        "subtitle": "استمتع بـ The Proven X في أي مكان.",
        "web": "مجتمع الويب",
        "web_desc": "المنصة الأساسية للسؤال والإجابة والتحقق.",
        "mobile": "تطبيق الهاتف",
        "mobile_desc": "خذ المجتمع معك أينما ذهبت. متاح الآن.",
        "plans": "الخطط",
        "free": "مجاني",
        "free_desc": "وصول كامل للقراءة والمساهمة.",
        "paid": "برو",
        "paid_desc": "ميزات متقدمة ودعم ذو أولوية.",
        "coming_soon": "قريباً",
        ...
        "price_free": "$0/شهر",
        "price_paid": "؟؟؟/شهر",
        "feature_ask": "اسأل عدداً غير محدود من الأسئلة",
        "feature_post": "انشر وتحقق من الإجابات",
        "feature_vote": "صوّت على المحتوى",
        "feature_profile": "ملف شخصي أساسي",
        "feature_everything": "كل شيء في المجاني",
        "feature_support": "دعم ذو أولوية",
        "feature_analytics": "تحليلات متقدمة",
        "feature_badges": "شارات مخصصة للملف الشخصي"
      },
      "blog": {
        "title": "المدونة",
  ...
  "tl": {
    "translation": {
      ...
      "products": {
        ...
        "subtitle": "Damhin ang The Proven X kahit saan.",
        "web": "Komunidad sa Web",
        "web_desc": "Ang pangunahing platform para sa pagtatanong, pagsagot, at pagpapatunay.",
        "mobile": "Mobile App",
        "mobile_desc": "Dalhin ang komunidad kahit saan. Available na ngayon.",
        "plans": "Mga Plano",
        "free": "Libre",
        "free_desc": "Buong access para magbasa at mag-ambag.",
        "paid": "Pro",
        "paid_desc": "Mga advanced na feature at priority support.",
        ...
        "price_free": "$0/buwan",
        "price_paid": "???/buwan",
        "feature_ask": "Magtanong ng walang limitasyon",
        "feature_post": "Mag-post at patunayan ang mga sagot",
        "feature_vote": "Bumoto sa nilalaman",
        "feature_profile": "Pangunahing profile",
        "feature_everything": "Lahat sa Libre",
        "feature_support": "Priority na suporta",
        "feature_analytics": "Advanced na analytics",
        "feature_badges": "Pasadyang mga badge ng profile"
      },
      "blog": {
        "title": "Blog",
  ...
  "hi": {
    "translation": {
      ...
      "products": {
        "title": "हमारे उत्पाद",
        "subtitle": "The Proven X का अनुभव कहीं भी करें।",
        "web": "वेब समुदाय",
        "web_desc": "पूछने, उत्तर देने और सत्यापित करने के लिए मुख्य मंच।",
        "mobile": "मोबाइल ऐप",
        "mobile_desc": "समुदाय को अपने साथ ले जाएं। अब उपलब्ध है।",
        "plans": "योजनाएं",
        "free": "मुफ़्त",
        "free_desc": "पढ़ने और योगदान करने के लिए पूर्ण पहुँच।",
        "paid": "प्रो",
        "paid_desc": "उन्नत सुविधाएँ और प्राथमिकता समर्थन।",
        "coming_soon": "जल्द आ रहा है",
        "open_app": "ऐप खोलें",
        "get_app": "ऐप प्राप्त करें",
        "join_now": "अभी जुड़ें",
        "price_free": "$0/माह",
        "price_paid": "???/माह",
        "feature_ask": "असीमित प्रश्न पूछें",
        "feature_post": "उत्तर पोस्ट करें और सत्यापित करें",
        "feature_vote": "सामग्री पर वोट करें",
        "feature_profile": "मूल प्रोफ़ाइल",
        "feature_everything": "मुफ़्त में सब कुछ",
        "feature_support": "प्राथमिकता समर्थन",
        "feature_analytics": "उन्नत विश्लेषिकी",
        "feature_badges": "कस्टम प्रोफ़ाइल बैज"
      },
      "blog": {
        "title": "ब्लॉग",
        "read_more": "और पढ़ें",
  ...
  "zh": {
    "translation": {
      ...
      "products": {
        "title": "我们的产品",
        "subtitle": "随时随地体验 The Proven X。",
        "web": "Web 社区",
        "web_desc": "提问、回答和验证的核心平台。",
        "mobile": "移动应用",
        "mobile_desc": "将社区随身携带。现已推出。",
        "plans": "计划",
        "free": "免费",
        "free_desc": "完全访问权限以阅读和贡献。",
        "paid": "专业版",
        "paid_desc": "高级功能和优先支持。",
        "coming_soon": "敬请期待",
        "open_app": "打开应用",
        ...
        "price_paid": "???/月",
        "feature_ask": "无限制提问",
        "feature_post": "发布并验证回答",
        "feature_vote": "对内容进行投票",
        "feature_profile": "基本个人资料",
        "feature_everything": "免费版中的所有内容",
        "feature_support": "优先支持",
        "feature_analytics": "高级分析",
        "feature_badges": "自定义个人资料徽章"
      },
      "blog": {
        "title": "博客",
        "read_more": "阅读更多",
  ...
  "fr": {
    "translation": {
      ...
      "products": {
        "title": "Nos produits",
        "subtitle": "Découvrez The Proven X partout.",
        "web": "Communauté Web",
        "web_desc": "La plateforme principale pour poser des questions, répondre et vérifier.",
        "mobile": "Application mobile",
        "mobile_desc": "Emportez la communauté avec vous. Disponible maintenant.",
        "plans": "Forfaits",
        "free": "Gratuit",
        "free_desc": "Accès complet pour lire et contribuer.",
        "paid": "Pro",
        "paid_desc": "Fonctionnalités avancées et support prioritaire.",
        ...
        "price_free": "0 $/mois",
        "price_paid": "???/mois",
        "feature_ask": "Poser des questions illimitées",
        "feature_post": "Publier et vérifier des réponses",
        "feature_vote": "Voter sur le contenu",
        "feature_profile": "Profil de base",
        "feature_everything": "Tout dans Gratuit",
        "feature_support": "Support prioritaire",
        "feature_analytics": "Analyses avancées",
        "feature_badges": "Badges de profil personnalisés"
      },
      "blog": {
        "title": "Blog",
  ...
  "es": {
    "translation": {
      ...
      "products": {
        ...
        "subtitle": "Experimenta The Proven X en cualquier lugar.",
        "web": "Comunidad Web",
        "web_desc": "La plataforma principal para preguntar, responder y verificar.",
        "mobile": "Aplicación móvil",
        "mobile_desc": "Lleva la comunidad contigo. Disponible ahora.",
        "plans": "Planes",
        "free": "Gratis",
        "free_desc": "Acceso completo para leer y contribuir.",
        "paid": "Pro",
        "paid_desc": "Funciones avanzadas y soporte prioritario.",
        ...
        "price_free": "$0/mes",
        "price_paid": "???/mes",
        "feature_ask": "Haz preguntas ilimitadas",
        "feature_post": "Publica y verifica respuestas",
        "feature_vote": "Vota por el contenido",
        "feature_profile": "Perfil básico",
        "feature_everything": "Todo en Gratis",
        "feature_support": "Soporte prioritario",
        "feature_analytics": "Análisis avanzados",
        "feature_badges": "Insignias de perfil personalizadas"
      },
      "blog": {
        "title": "Blog",
        "read_more": "Leer más",
  ...
  "ru": {
    "translation": {
      ...
      "products": {
        "title": "Наши продукты",
        "subtitle": "Используйте The Proven X где угодно.",
        "web": "Веб-сообщество",
        "web_desc": "Основная платформа для вопросов, ответов и проверок.",
        "mobile": "Мобильное приложение",
        "mobile_desc": "Возьмите сообщество с собой. Доступно сейчас.",
        "plans": "Планы",
        "free": "Бесплатно",
        "free_desc": "Полный доступ к чтению и участию.",
        "paid": "Про",
        "paid_desc": "Расширенные функции и приоритетная поддержка.",
        "coming_soon": "Скоро",
        ...
        "price_free": "$0/мес",
        "price_paid": "???/мес",
        "feature_ask": "Задавайте неограниченное количество вопросов",
        "feature_post": "Публикуйте и проверяйте ответы",
        "feature_vote": "Голосуйте за контент",
        "feature_profile": "Базовый профиль",
        "feature_everything": "Всё в Бесплатном",
        "feature_support": "Приоритетная поддержка",
        "feature_analytics": "Расширенная аналитика",
        "feature_badges": "Пользовательские значки профиля"
      },
      "blog": {
        "title": "Блог",
  ...
  "uk": {
    "translation": {
      ...
      "products": {
        "title": "Наші продукти",
        "subtitle": "Використовуйте The Proven X будь-де.",
        "web": "Веб-спільнота",
        "web_desc": "Основна платформа для запитань, відповідей та перевірок.",
        "mobile": "Мобільний додаток",
        "mobile_desc": "Візьміть спільноту з собою. Доступно зараз.",
        "plans": "Плани",
        "free": "Безкоштовно",
        "free_desc": "Повний доступ до читання та участі.",
        "paid": "Про",
        "paid_desc": "Розширені функції та пріоритетна підтримка.",
        ...
        "price_free": "$0/міс",
        "price_paid": "???/міс",
        "feature_ask": "Задавайте необмежену кількість питань",
        "feature_post": "Публікуйте та перевіряйте відповіді",
        "feature_vote": "Голосуйте за контент",
        "feature_profile": "Базовий профіль",
        "feature_everything": "Все в Безкоштовному",
  ...
  "fa": {
    "translation": {
      ...
      "products": {
        "title": "محصولات ما",
        "subtitle": "تجربه The Proven X در هر مکان.",
        "web": "جامعه وب",
        "web_desc": "پلتفرم اصلی برای پرسش، پاسخ و تایید.",
        "mobile": "اپلیکیشن موبایل",
        "mobile_desc": "جامعه را همراه خود داشته باشید. هم‌اکنون در دسترس است.",
        "plans": "برنامه‌ها",
        "free": "رایگان",
        "free_desc": "دسترسی کامل برای خواندن و مشارکت.",
        "paid": "حرفه‌ای",
        "paid_desc": "ویژگی‌های پیشرفته و پشتیبانی ویژه.",
        "coming_soon": "به زودی",
        ...
        "price_free": "$0/ماه",
        "price_paid": "؟؟؟/ماه",
        "feature_ask": "پرسش نامحدود سوال",
        "feature_post": "ارسال و تایید پاسخ",
        "feature_vote": "رای دادن به محتوا",
        "feature_profile": "پروفایل پایه",
        "feature_everything": "همه چیز در رایگان",
        "feature_support": "پشتیبانی ویژه",
        "feature_analytics": "تجزیه و تحلیل پیشرفته",
        "feature_badges": "نشان‌های اختصاصی پروفایل"
      },
      "blog": {
        "title": "وبلاگ",
  ...
  "ur": {
    "translation": {
      ...
      "products": {
        "title": "ہماری مصنوعات",
        "subtitle": "The Proven X کا تجربہ کہیں بھی کریں۔",
        "web": "ویب کمیونٹی",
        "web_desc": "پوچھنے، جواب دینے اور تصدیق کرنے کا بنیادی پلیٹ فارم۔",
        "mobile": "موبائل ایپ",
        "mobile_desc": "کمیونٹی کو اپنے ساتھ لے جائیں۔ اب دستیاب ہے۔",
        "plans": "منصوبے",
        "free": "مفت",
        "free_desc": "پڑھنے اور حصہ لینے کے لیے مکمل رسائی۔",
        "paid": "پرو",
        "paid_desc": "اعلیٰ خصوصیات اور ترجیحی تعاون۔",
        ...
        "price_free": "$0/ماہ",
        "price_paid": "؟؟؟/ماہ",
        "feature_ask": "لامحدود سوالات پوچھیں",
        "feature_post": "جوابات شائع اور تصدیق کریں",
        "feature_vote": "مواد پر ووٹ دیں",
        "feature_profile": "بنیادی پروفائل",
        "feature_everything": "مفت میں سب کچھ",
        "feature_support": "ترجیحی تعاون",
        "feature_analytics": "اعلیٰ تجزیات",
        "feature_badges": "حسب ضرورت پروفائل بیج"
      },
      "blog": {
        "title": "بلاگ",
  ...
  "bn": {
    "translation": {
      ...
      "products": {
        "title": "আমাদের পণ্য",
        "subtitle": "যে কোনো জায়গায় The Proven X অভিজ্ঞতা নিন।",
        "web": "ওয়েব সম্প্রদায়",
        "web_desc": "জিজ্ঞাসা, উত্তর এবং যাচাই করার জন্য মূল প্ল্যাটফর্ম।",
        "mobile": "মোবাইল অ্যাপ",
        "mobile_desc": "সম্প্রদায়কে আপনার সাথে নিয়ে যান। এখন উপলব্ধ।",
        "plans": "পরিকল্পনা",
        "free": "বিনামূল্যে",
        "free_desc": "পড়া এবং অবদান রাখার জন্য সম্পূর্ণ অ্যাক্সেস।",
        "paid": "প্রো",
        "paid_desc": "উন্নত বৈশিষ্ট্য এবং অগ্রাধিকার সমর্থন।",
        "coming_soon": "শীঘ্রই আসছে",
        "open_app": "অ্যাপ খুলুন",
        "get_app": "অ্যাপ পান",
        "join_now": "এখনই যোগ দিন",
        "price_free": "$0/মাস",
        "price_paid": "???/মাস",
        "feature_ask": "সীমাহীন প্রশ্ন করুন",
        "feature_post": "উত্তর পোস্ট এবং যাচাই করুন",
        "feature_vote": "কন্টেন্টে ভোট দিন",
        "feature_profile": "মৌলিক প্রোফাইল",
        "feature_everything": "বিনামূল্যের সবকিছু",
        "feature_support": "অগ্রাধিকার সমর্থন",
        "feature_analytics": "উন্নত অ্যানালিটিক্স",
        "feature_badges": "কাস্টম প্রোফাইল ব্যাজ"
      },
      "blog": {
        "title": "ব্লগ",
        "read_more": "আরও পড়ুন",
  ...
  "tr": {
    "translation": {
      ...
      "products": {
        "title": "Ürünlerimiz",
        "subtitle": "The Proven X'i her yerde deneyimleyin.",
        "web": "Web Topluluğu",
        "web_desc": "Soru sormak, cevaplamak ve doğrulamak için temel platform.",
        "mobile": "Mobil Uygulama",
        "mobile_desc": "Topluluğu yanınızda taşıyın. Şimdi mevcut.",
        "plans": "Planlar",
        "free": "Ücretsiz",
        "free_desc": "Okumak ve katkıda bulunmak için tam erişim.",
        "paid": "Pro",
        "paid_desc": "Gelişmiş özellikler ve öncelikli destek.",
        "coming_soon": "Yakında",
        ...
        "price_free": "$0/ay",
        "price_paid": "???/ay",
        "feature_ask": "Sınırsız soru sor",
        "feature_post": "Cevapları paylaş ve doğrula",
        "feature_vote": "İçeriği oyla",
        "feature_profile": "Temel profil",
        "feature_everything": "Ücretsizdeki her şey",
        "feature_support": "Öncelikli destek",
        "feature_analytics": "Gelişmiş analitik",
        "feature_badges": "Özel profil rozetleri"
      },
      "blog": {
        "title": "Blog",
